...
<div class="container">
    <form method="post">
        ...
        <!-- duration date -->
        <div class="row">
            <div class="col-md-2">Trip Date</div>
        ...
        <div class="row form-group">
            <div class="col-md-2">Hotel Stars</div>
            <div class="col-md-10">
                <div class="col-md-1">From</div>
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <input id="input-1" name="input-1" class="rating rating-loading" data-min="1" data-max="5"
                           data-step="1" data-size="xs" data-show-clear="false" data-show-caption="false">
                </div>
                <div class="col-md-1">To</div>
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <input id="input-2" name="input-2" class="rating rating-loading" data-min="1" data-max="5"
                           data-step="1" data-size="xs" data-show-clear="false" data-show-caption="false">
                </div>
            </div>
        </div>
        ...
        <!-- Hotel Rating -->
        <div class="row form-group">
            <div class="col-md-2">Hotel Rating</div>
            <div class="col-md-10">
                <div class="col-md-1">From</div>
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <input id="input-1" name="input-1" class="rating rating-loading" data-min="1" data-max="5"
        ...
        <!-- Gust Rating -->
        <div class="row form-group">
            <div class="col-md-2">Guest Rating</div>
            <div class="col-md-10">
                <div class="col-md-1">From</div>
                <div class="col-md-4 col-sm-12 col-xs-12">
                    <input id="input-1" name="input-1" class="rating rating-loading" data-min="1" data-max="5"
